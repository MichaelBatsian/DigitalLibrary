...
namespace Godeltech.Mastery.Web.DigitalLibrary.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl, string currentPath)
        {
            if (!ModelState.IsValid)
            {
                //return View("~/Views/Home/About.cshtml", model);
                return View(currentPath, model);
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    string code = await _userManager.GenerateEmailConfirmationTokenAsync(user.UserId);
                    var callbackUrl = Url.Action("ConfirmEmail", "Account", new { userId = user.UserId, code = code },
                        protocol: Request.Url.Scheme);
                    await _userManager.SendEmailAsync(user.UserId, "Confirm your account",
